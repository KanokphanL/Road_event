...
class MaxIoUAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        gt_action_labels = gt_instances.action_labels
        gt_location_labels = gt_instances.location_labels
        ...
        if assign_on_cpu:
            ...
            gt_action_labels = gt_action_labels.cpu()
            gt_loc_labels = gt_loc_labels.cpu()
        ...
        assign_result = self.assign_wrt_overlaps(overlaps, gt_labels, gt_action_labels, gt_location_labels)
    ...
    def assign_wrt_overlaps(self, overlaps: Tensor,
                            gt_labels: Tensor, action_labels: Tensor, location_labels: Tensor) -> AssignResult:
        ...
        if num_gts == 0 or num_bboxes == 0:
            ...
            assigned_labels = overlaps.new_full((num_bboxes, ),
                                                -1,
                                                dtype=torch.long)
            assigned_action_labels = overlaps.new_full((num_bboxes, len(action_labels[0])),
                                                -1,
                                                dtype=torch.long)
            assigned_location_labels = overlaps.new_full((num_bboxes, len(location_labels[0])),
                                                -1,
                                                dtype=torch.long)
            if num_gts == 0:
            ...
            return AssignResult(
                ...
                action_labels=assigned_action_labels,
                location_labels=assigned_location_labels,
            )
        ...
        assigned_action_labels = assigned_gt_inds.new_full((num_bboxes, len(action_labels[0])), -1)
        assigned_location_labels = assigned_gt_inds.new_full((num_bboxes, len(location_labels[0])), -1)
        ...
        if pos_inds.numel() > 0:
            assigned_labels[pos_inds] = gt_labels[assigned_gt_inds[pos_inds] -
                                                  1]
            assigned_action_labels[pos_inds] = action_labels[assigned_gt_inds[pos_inds] -
                                                  1]
            assigned_location_labels[pos_inds] = location_labels[assigned_gt_inds[pos_inds] -
                                                  1]
