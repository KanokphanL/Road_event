...
class SamplingResult(util_mixins.NiceRepr):
    ...
    def __init__(self,
        ...
        self.pos_action_labels = assign_result.action_labels[pos_inds]
        self.pos_location_labels = assign_result.location_labels[pos_inds]
    ...
    def random(cls, rng=None, **kwargs):
        ...
        action_labels = torch.randint(
            0, 5, (assign_result.num_gts, len(assign_result.action_labels[0])), dtype=torch.long)
