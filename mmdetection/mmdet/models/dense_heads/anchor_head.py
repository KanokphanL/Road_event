...
class AnchorHead(BaseDenseHead):
    ...
    def _get_targets_single(self,
        ...
        labels = anchors.new_full((num_valid_anchors, ),
                                  self.num_classes,
                                  dtype=torch.long)
        # action_labels = anchors.new_full((num_valid_anchors, len(sampling_result.pos_action_labels[0])),
        #                           len(sampling_result.pos_action_labels[0]),
        #                           dtype=torch.long)
        # location_labels = anchors.new_full((num_valid_anchors, len(sampling_result.pos_location_labels[0])),
        #                           len(sampling_result.pos_location_labels[0]),
        #                           dtype=torch.long)
        ...
        if len(pos_inds) > 0:
            ...
            # action_labels[pos_inds] = sampling_result.pos_action_labels
            # location_labels[pos_inds] = sampling_result.pos_location_labels
        ...
        if unmap_outputs:
            ...
            # action_labels = unmap(
            #     action_labels, num_total_anchors, inside_flags,
            #     fill=len(action_labels[0]))  # fill bg label
            # location_labels = unmap(
            #     location_labels, num_total_anchors, inside_flags,
            #     fill=len(location_labels[0]))  # fill bg label
