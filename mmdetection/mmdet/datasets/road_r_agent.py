...
class RoadRAgentDataset(BaseDetDataset):
    """Dataset for COCO."""
    ...
    def filter_labels(self, ids, all_labels, used_labels):
        """Filter the used ids"""
        used_ids = []
        for id in ids:
            label = all_labels[id]
    ...
    def load_data_list(self) -> List[dict]:
        ...
        for img_id in img_ids:
            ...
            # print("raw_ann_info", raw_ann_info)
    ...
    def parse_data_info(self, raw_data_info: dict) -> Union[dict, List[dict]]:
        ...
        for i, ann in enumerate(ann_info):
            ...
            loc_id = [0] * len(self.loc_classes)   
            for i in location_id:
                loc_id[i] = 1
        
            
            instance['bbox_label'] = agent_id[0]          
            instance['agent_label'] = agent_id[0] 
